...
<form name="book" method="post">
		<div class="selectroom_top">
			<div class="col-md-4 selectroom_left " >
				<img src="1.jpg" width="300" height="300" alt="">
			</div>
			<div class="col-md-8 selectroom_right">
				...
				<div>
					<H2> Package Duration : 21-12-2022 TO 25-12-2022 </H2>
</div>
			</div>
		...
		<div class="selectroom_top">
			...
			<div>
				<ul>
					...
					<button type="submit" name="submit2" class="btn-primary btn"><h1>Book</h1></button>
						</li>
						<?php } else {?>
